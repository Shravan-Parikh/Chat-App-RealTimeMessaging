...
const HomePage = () => {
  ...
  return (
    <div className="relative">
      <div className="py-14 bg-[#33DAFF] w-full"></div>
      ...
      <div className="absolute w-[97vw] h-[94vh] bg-[#f0f2f5] top-6 left-6 flex">
          ...
          <div className="w-[70%] flex flex-col items-center justify-center">
            <div className="max-w-[70%] text-center">
              <img
                ...
                alt=""
              />
              <h1 className="text-4xl text-gray-600">ChatApp</h1>
              <p className=" my-9">
                send and reveive message in realtime.
        ...
        {currentChat && (
          <div className="w-[70%] bg-blue-100 relative">
            ...
            <div className="footer bg-[#73D4E9] absolute bottom-0 w-full py-3 text-2xl">
