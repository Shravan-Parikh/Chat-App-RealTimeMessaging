...
// dispacth register action
  ...
  return (
    ...
    <div>
      ...
      <div className="w-[30%] p-10 shadow-md bg-white rounded-md border-1">
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <p className="mb-2">User Name</p>
            <input
              className="py-2 px-3 outline outline-[#33DAFF] w-full rounded-md border-1"
              type="text"
          ...
          <div>
            ...
            <input
              className="py-2 px-2 outline outline-[#33DAFF] w-full rounded-md border-1"
              type="text"
          ...
          <div>
            <input
              className="py-[0.7rem] px-3 w-full rounded-md bg-[#33DAFF] text-white mt-3"
              type="Submit"
              placeholder="Enter your Password"
              value={"Signup"}
              readOnly
